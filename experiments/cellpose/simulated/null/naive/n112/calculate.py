...
import sys
sys.path.append("/scratch/user/s4702415/SigCells/experiments/cellpose/simulated/null")
# sys.path.append("/scratch/user/s4702415/SigCells/data")


if __name__=="__main__":
    
    print(f"Naive P-Value 112, Negative control Cellpose N(0, 1)")
    # load model
    path_56 = "/scratch/user/s4702415/trained_models/cellpose/cellpose_n112.onnx/cyto3.onnx"
